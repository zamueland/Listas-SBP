 ...
 * @author Zamuel
 */
public class PanelDibujoPrestamos extends javax.swing.JPanel {
    ...
    public PanelDibujoPrestamos(int valor, String nombreNodo,ListaPrestamos lista) {
    ...
    PanelDibujoPrestamos(int size, String string, ListaUsuario listaPrestamos) {
    ...
    public void paint(Graphics g) {
        ...
        for (int i = 0; i < valor; i++) {
            ...
            g.drawString(lista.get(i).clave +"  " +lista.get(i).dato.getCodigoPrestamo(), disNombre, 58);
